const local: App.I18n.Schema = {
  console: {
    ...
    welcome: 'You are signed in to the platform workspace.',
    identity: 'Account',
    context: 'Workspace',
    platform: 'Platform',
    loading: 'Checking your session…',
    retry: 'Retry',
    logout: 'Sign out everywhere in this Console',
    blocked: 'The session could not be confirmed. Protected content is hidden.',
    ...
    footer: 'Your session is shared across Console tabs. Signing out ends it for every tab.'
  },
  system: {
    title: 'SaaS Forge',
